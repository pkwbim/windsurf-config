...
Use `[project-specific]` to convert between single-file, multi-file, and class-based formats.
...
- Islands (`- Deferred/bundled loading: `defer`, `lazy.bundle` for optimized component loading.

| Feature | Usage | Purpose |
|---------|-------|---------|
| Islands | `| Async | `wire:click.async` or `#[Async]` | Non-blocking actions |
